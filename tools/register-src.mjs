// 一条命令跑 src/ 相关的测试脚本，自动挂上 src-resolve-loader
// ---------------------------------------------------------------------------
// 用法：
//   node tools/register-src.mjs tools/test-rig-semantics.mjs [更多参数...]
//
// 存在的理由见 src-resolve-loader.mjs 顶部注释：src/ 用的是 bundler 风格的
...
//    当成 scheme，报 ERR_UNSUPPORTED_ESM_URL_SCHEME。见 src-resolve-loader.mjs。
